...
class Manifest {
    ...
    constructor(github, targetBranch, repositoryConfig, releasedVersions, manifestOptions) {
        ...
        this.excludePackagesFromRoot =
            (_c = manifestOptions === null || manifestOptions === void 0 ? void 0 : manifestOptions.excludePackagesFromRoot) !== null && _c !== void 0 ? _c : false;
    }
    /**
    ...
    static async fromConfig(github, targetBranch, config, manifestOptions, path = exports.ROOT_PROJECT_PATH) {
        ...
        const strategy = await (0, factory_1.buildStrategy)({
            github,
            groupPullRequestTitlePattern: manifestOptions === null || manifestOptions === void 0 ? void 0 : manifestOptions.groupPullRequestTitlePattern,
            ...config,
        });
    ...
    async buildPullRequests() {
        ...
        for (const path in this.repositoryConfig) {
            commitsPerPath[path] = commitsAfterSha(!this.excludePackagesFromRoot && path === exports.ROOT_PROJECT_PATH
                ? commits
                : splitCommits[path], releaseShasByPath[path]);
        }
